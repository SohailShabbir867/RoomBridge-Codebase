...
/* ── AuthLayout: Navbar + auth form content (no Footer) ─────────
   BUG FIX: Auth pages (login/register/forgot/reset) are now in their
...
const NotFoundPage = () => (
  <div className="min-h-screen flex flex-col items-center justify-center bg-background p-8">
    ...
    <h1 className="text-4xl font-bold text-primary mb-3">404 — Page Not Found</h1>
    <p className="text-text-secondary mb-8 text-lg text-center max-w-md">
      The page you're looking for doesn't exist or has been moved.
    </p>
    {/* BUG FIX: was <a href="/"> which causes a full page reload.
