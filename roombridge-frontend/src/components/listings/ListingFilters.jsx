...
import {
  RiSearchLine, RiMapPin2Line, RiMoneyDollarCircleLine,
  RiHome4Line, RiFilterLine, RiCloseLine, RiRefreshLine,
} from 'react-icons/ri';
...
const ListingFilters = ({
  ...
  const hasActiveFilters = !!(
    filters.search || filters.city || filters.roomType ||
    filters.minRent || filters.maxRent || filters.genderPreference ||
    filters.furnished
  );
  ...
  const FilterContent = () => (
    <div className="space-y-5">
      ...
      {/* Search */}
      <div>
        <label className="label" htmlFor="lf-search">Search</label>
      ...
      {/* Room Type */}
      <div>
        <label className="label" htmlFor="lf-roomType">Room Type</label>
        <div className="relative">
      ...
      {/* Gender preference */}
      <div>
        <label className="label" htmlFor="lf-gender">Gender Preference</label>
        <select
          id="lf-gender"
      ...
      {/* Sort */}
      <div>
        <label className="label" htmlFor="lf-sort">Sort By</label>
        <select
          id="lf-sort"
  ...
  return (
    <>
          ...
          <div className="flex items-center justify-between mb-4">
            ...
            {hasActiveFilters && (
              <span className="text-xs bg-primary text-white px-1.5 rounded-full font-bold">
                {[filters.search, filters.city, filters.roomType, filters.minRent,
                  filters.maxRent, filters.genderPreference, filters.furnished]
      ...
      <div className="lg:hidden">
        ...
        {/* Drawer */}
        <div className={`fixed right-0 top-0 bottom-0 z-50 w-80 max-w-full bg-white shadow-hover
