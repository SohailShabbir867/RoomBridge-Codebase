...
const FEATURES = [
  ...
  { icon: RiGroupLine, text: "Smart roommate matching by lifestyle & budget" },
  {
    ...
    text: "Secure messaging & booking — all in one place",
  },
];
...
const LoginPage = () => {
  ...
  /*
    read location.state.from so we can redirect back to the
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      */
      ...
      /*
        redirect to the page they were trying to visit (from),
      ...
      <div className="hidden lg:flex lg:w-5/12 xl:w-1/2 bg-primary flex-col justify-between p-12">
        ...
        <div>
          <h1 className="text-4xl xl:text-5xl font-bold text-white leading-tight mb-4">
            Find Your <span className="text-accent">Perfect</span>
            <br />
            Room in Pakistan
          </h1>
