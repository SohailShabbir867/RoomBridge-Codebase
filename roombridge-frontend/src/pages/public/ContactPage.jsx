...
import {
  RiMailLine, RiPhoneLine, RiMapPin2Line, RiSendPlaneLine,
  RiTwitterXLine, RiFacebookBoxLine, RiInstagramLine,
  RiCheckLine, RiCustomerService2Line, RiTimeLine,
} from 'react-icons/ri';
import toast from 'react-hot-toast';

const CONTACT_INFO = [
  { icon: RiMapPin2Line,         label: 'Address',        value: 'F-7/2, Islamabad, Pakistan'    },
  { icon: RiMailLine,            label: 'Email',          value: 'hello@roombridge.pk'            },
  { icon: RiPhoneLine,           label: 'Phone',          value: '+92 300 1234567'                },
  { icon: RiTimeLine,            label: 'Support Hours',  value: 'Mon–Sat, 9 AM – 6 PM PKT'      },
];

const FAQ = [
  { q: 'Is RoomBridge free to use?',         a: 'Yes! Searching and contacting owners is 100% free for seekers.' },
  { q: 'How do I list my room?',             a: 'Create an Owner account, click "Create Listing" and fill in the details.' },
  { q: 'Are listings verified?',             a: 'We manually review listings and verify owner IDs before approving.' },
  { q: 'How does roommate matching work?',   a: 'Complete your lifestyle profile and our algorithm calculates a compatibility score.' },
];
      ...
      <section className="bg-primary py-16 px-4 sm:px-6 lg:px-8 text-center">
        <div className="max-w-2xl mx-auto">
          ...
          <p className="text-white/70 text-lg">
            Have a question, feedback, or need help? Our team responds within 24 hours.
          </p>
        </div>
      </section>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
          ...
          <div className="space-y-4">
            <div className="bg-white rounded-card border border-border p-6">
              <h2 className="text-lg font-bold text-primary mb-5">Contact Information</h2>
              <div className="space-y-4">
              ...
              <div className="mt-6 pt-5 border-t border-border">
                <p className="text-xs font-semibold text-text-secondary uppercase tracking-wider mb-3">Follow Us</p>
            ...
            <div className="bg-primary/5 rounded-card border border-primary/20 p-5">
              <h3 className="font-semibold text-primary text-sm mb-3">Quick Help</h3>
              {[
                ...
                <a key={label} href="#contact-form"
                  ...
                  <RiSendPlaneLine className="text-secondary opacity-0 group-hover:opacity-100
          ...
          <div className="lg:col-span-2">
            <div id="contact-form" className="bg-white rounded-card border border-border p-8">
                ...
                <form onSubmit={handleSubmit} noValidate className="space-y-5">
                  ...
                  <div>
                    ...
                    <textarea name="message" value={form.message} onChange={handleChange}
                              rows={6} placeholder="Describe your issue or question in detail…"
            ...
            {FAQ.map(({ q, a }, i) => (
              <div key={i}
                ...
                <button
                  ...
                  <span className={`text-secondary text-lg font-bold transition-transform duration-200
