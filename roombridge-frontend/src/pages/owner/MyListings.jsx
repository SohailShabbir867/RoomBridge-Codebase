...
import {
  RiArrowLeftLine, RiHome4Line, RiLoader4Line, RiAddLine,
  RiEditLine, RiDeleteBinLine, RiEyeLine, RiMapPin2Line,
...
const MyListings = () => {
  ...
  useEffect(() => {
    listingService.getMyListings({ limit: 50 })
      .then(res => {
        /*
    ...
    <div className="min-h-screen bg-background">
      <header className="sticky top-0 z-20 bg-white border-b border-border px-6 py-4 flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="font-bold text-primary">My Listings</h1>
            <p className="text-text-secondary text-xs">{listings.length} total listings</p>
          </div>
        </div>
      ...
      <div className="max-w-5xl mx-auto px-4 py-6">
        ...
        {loading ? (
          ...
          <div className="text-center py-20 bg-white rounded-card border border-border shadow-card">
            ...
            {filter === 'all' && (
              <Link to="/owner/listings/create" className="btn-primary inline-flex items-center gap-2">
            ...
            {filtered.map(l => (
              <div key={l._id}
                ...
                <div className="relative">
                  <img
                    src={l.photos?.[0]?.url || 'https://images.unsplash.com/photo-1555041469-a586c61ea9bc?w=400&q=80'}
                    alt={l.title}
                  ...
                  {l.bookingCount > 0 && (
                    <div className="absolute top-3 right-3 bg-primary text-white text-xs
                ...
                {/* Info */}
                <div className="p-4">
                  <h3 className="font-semibold text-primary line-clamp-1 mb-1">{l.title}</h3>
                  ...
                  <div className="flex gap-2 pt-3 border-t border-border">
                    ...
                    <Link to={`/owner/listings/${l._id}/edit`}
                          className="flex-1 flex items-center justify-center gap-1.5 py-2 rounded-btn
