      ...
      <div className="max-w-3xl mx-auto px-4 py-8">
        <form onSubmit={handleSubmit} noValidate className="space-y-8">
          ...
          <div className="bg-white rounded-card border border-border shadow-card p-6">
            ...
            <div className="grid grid-cols-3 sm:grid-cols-6 gap-3 mb-3">
              ...
              {form.existingPhotos.map((p, i) => (
                ...
                >
                  ...
                  <button
                    type="button"
                    onClick={() => removeExisting(p.public_id)}
              ...
              {newPhotos.map((p, i) => (
                ...
                >
                  ...
                  <span className="absolute bottom-1 left-1 text-[9px] bg-secondary text-white px-1 rounded">
                    New
                  </span>
                </div>
              ))}
            ...
            />
            {errors.photos && (
              <p className="text-xs text-error">{errors.photos}</p>
            )}
          </div>
          ...
          <div className="flex gap-3">
            ...
            >
              {saving ? (
                ...
                <>
                  <RiCheckboxCircleLine /> Save Changes
                </>
              )}
            </button>
          </div>
