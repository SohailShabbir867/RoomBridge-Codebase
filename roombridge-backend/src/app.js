...
/* ── Global rate limiter ───────────────────────────────── */
/* Azure App Service passes IPs via X-Forwarded-For.        */
/* trust proxy is already set above (line 28).              */
/* Disable express-rate-limit's built-in IP validations     */
/* to avoid ERR_ERL_INVALID_IP_ADDRESS on Azure.            */
...
app.use("/api/v1/alerts", subscriptionRoutes);
