...
const fileFilter = (req, file, cb) => {
  if (ALLOWED_MIME_TYPES.includes(file.mimetype)) {
    ...
    const err  = new Error('Unsupported file type. Only JPEG, PNG, and WebP images are allowed.');
...
// BUG FIX: was missing `req` as first parameter — Express error handlers receive
 ...
 */
const uploadMultiple = (fieldName = 'photos', maxCount = 6) => (req, res, next) => {
